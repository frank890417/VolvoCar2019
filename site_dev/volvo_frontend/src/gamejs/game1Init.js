...
function addG1PrePlay(){
    ...
    .add(()=>{
        game1Data.pedal.tint = 0XFFFFFF;
        common.prePlayStartTextG1.text = "5";
        common.prePlayStartTextG1.visible = true;
        
    }, 1)
    .add(()=>{
        common.prePlayStartTextG1.text = "4";
    }, 2)
    .add(()=>{
        game1Data.pedal.tint = 0X555555;
        common.prePlayStartTextG1.text = "3";
        game1Data.pressStop = false;   
        game1Data.cityRoadAniBg.animationSpeed = game1Data.bgAnimationSpeed;
    }, 3)
    .add(()=>{
        //停車安全讓汽車通過
        common.prePlayStartTextG1.text = "2";
    }, 4)
    .add(()=>{
        common.prePlayStartTextG1.text = "1";
    }, 5)
    .add(()=>{
        common.prePlayStartTextG1.text = "GO!";
    }, 6)
    .add(()=>{
        game1Data.pedal.tint = 0XFFFFFF;
