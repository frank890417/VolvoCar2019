...
function game1Setup(Vars){
    ...
    game1Data.prePlayStartTextG1 = new PIXI.Text("5", new PIXI.TextStyle({
        fontSize: 180,
        fill: '#FFFFFF',
        fontWeight: 500
    }));

    game1Data.prePlayStartTextG1.position.set(common.app.screen.width/2, common.app.screen.height/2 - 200);
    game1Data.prePlayStartTextG1.anchor.set(0.5, 0.5);
    ...
    common.stage1.addChild(game1Data.prePlayStartTextG1);
